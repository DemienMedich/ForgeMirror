...
- State:
  - Ветка: codex/tasks-module-ux. Версия: 0.4.37.
  - Последнее изменение: рабочий режим `Задачи` получил компактную карточку `Очередь задач` с основными сигналами и быстрым переходом к фокус-задаче; подробные pipeline-риски больше не занимают место без сигналов.
