...
- State:
  - Ветка: beta. Версия: 0.4.36.
  - Последнее изменение: экран `Задачи` разделён на режимы `Оперативно` и `Администрирование`; создание задач, проекты, аудит, массовые действия и inline-правки скрыты из рабочего потока.
- Done:
