...
- State:
  - Ветка: develop. Версия: 0.4.98.
  - Последнее изменение: общий UX pass, пункт 7 `плотность таблиц и читаемость строк`: compact padding основной таблицы задач, уже служебные колонки и короткий stage-code с tooltip.
