...
- State: Stage 51 implementation is on codex/qt-gui. Project filters and sort order now work in Qt and persist in the isolated settings file; stable branches remain unchanged.
...
- Now: Stages 47–50 compiled and were pushed. Stage 51 ports project overdue/XP-pending filters and four project sort modes, and persists them with task/report filters; compile verification is pending. This is not a release checkpoint: no tests or installer lifecycle checks were run. Stage 46 remains the latest verified installer, version 0.6.11; release evidence: docs/releases/ForgeMirror-0.6.11.md.
