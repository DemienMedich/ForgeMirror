...
- State:
  - Ветка: develop. Версия: 0.4.95.
  - Последнее изменение: продолжен общий UX pass, пункт 6 `визуальная иерархия и статусы`: summary/detail сигналы проектов и задач переведены на status pills.
