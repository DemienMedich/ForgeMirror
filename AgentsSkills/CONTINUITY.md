...
- State:
  - Ветка: codex/tasks-module-ux. Версия: 0.4.52.
  - Последнее изменение: уплотнен wizard создания задачи: stepper, inline-проект, навигация и multiline-поля.
...
- Next:
  - Продолжить icon-pass: заменить редкие detail-actions и вторичные кнопки создания/редактирования задач на иконки с tooltip, не трогая первичные CTA.
