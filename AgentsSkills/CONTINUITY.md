...
- State: Stage 32 pushed as c3b976e. Stage 33 adds guarded deletion of unused skills with checked persistence and crash recovery; full verification passed. Stable branches unchanged.
...
- Now: Stage 33 ready for commit/push: unused-skill deletion checks tasks, active/archived profiles and achievements, journals skills.txt, verifies the full reloaded catalog and exercises the real Qt confirmation path. Full build, smoke_qt/smoke_core, native visual QA and packaged startup without Qt on PATH passed with empty stderr.
