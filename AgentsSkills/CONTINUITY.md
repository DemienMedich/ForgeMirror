...
- State: Stage 31 pushed as d8fee43. Stage 32 adds guarded profession deletion with crash-safe cross-file recovery; full verification passed. Stable branches unchanged.
...
- Now: Stage 32 ready for commit/push: profession deletion clears active-profile and skill bindings under a durable journal, blocks archived-profile references, and exercises the real Qt confirmation path. Full build, smoke_qt/smoke_core, native visual QA and packaged startup without Qt on PATH passed with empty stderr.
