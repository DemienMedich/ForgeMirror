...
- State:
  - Ветка: develop. Версия: 0.4.99.
  - Последнее изменение: общий UX pass, пункт 7 `плотность таблиц и читаемость строк`: compact audit/summary таблицы задач и clipping длинных audit-значений.
