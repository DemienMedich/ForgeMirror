...
- State:
  - Ветка: develop. Версия: 0.5.14.
  - Последнее изменение: внеплановый bugfix: исправлен ImGui ID conflict в карточке задач профиля; парольные модалки отправляются по Enter; админ получил опцию `Не выходить`.
