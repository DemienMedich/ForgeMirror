...
- State: Stage 29 pushed as 05447a0. Stage 30 adds atomic UTF-8 CSV export to the Qt Statistics page; full verification passed. Stable branches unchanged.
...
- Now: Stage 30 ready for commit/push: the Statistics page exports the current existing TeamValueReport through a Qt save dialog and atomic UTF-8-BOM writer. Tests cover content, invalid paths, destination locking and the real UI action. Full build, smoke_qt/smoke_core, native visual QA and packaged startup without Qt on PATH passed with empty stderr.
