...
- State:
  - Ветка: develop. Версия: 0.5.42.
  - Последнее изменение: UX plan point 11 `семантика иконок`: завершен финальный проход по универсальным иконкам, фильтрам и tooltip-контрактам.
