...
- State:
  - Ветка: develop. Версия: 0.5.40.
  - Последнее изменение: UX plan point 11 `семантика иконок`: выполнен первый проход по критичным действиям и добавлены отдельные glyph-иконки.
