...
- State: Stage 4 project and skill editors implemented and verified; full migration remains in progress.
...
- Now: Stage 4 verified: project editing preserves IDs and task links; skill creation/editing stages and verifies the entire catalog before atomic replacement. smoke_qt, smoke_core and native Windows tests pass. Skill form visually inspected; packaged startup with no Qt on PATH exits 0, stderr empty. Commit/push to codex/qt-gui. Stable branches and colors untouched.
- Next: Continue Qt migration: full task/pipeline editors, personal login/access policies, destructive operations with rollback, skill profession assignment, achievements, settings, cloud, Pomodoro, vault and 3D. Legacy catalog category+profession serialization is lossy; Qt rejects unsafe round trips instead of changing the shared format.
