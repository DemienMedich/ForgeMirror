...
- State: Stage 23 pushed as 983a2a9. Stage 24 adds crash-safe recovery around cross-file project deletion; full verification passed. Stable branches unchanged.
...
- Now: Stage 24 ready for commit/push: project deletion snapshots projects/tasks, both last-good backups and task audit before mutation, atomically marks success, and restores an interrupted uncommitted operation on reload. Full build, smoke_qt/smoke_core, native smoke and packaged startup without Qt on PATH passed with empty stderr.
