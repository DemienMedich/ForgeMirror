...
- Now:
  - Профиль: вкладка `Диаграмма` переименована в `Аналитика`, внутренний collapsing-заголовок аналитики убран, фокус-режим получил доступ к `Задачам`, а радар навыков стал компактнее.
- Next:
  - Продолжить крупную компоновку профиля: уплотнить `Навыки`/`Ачивки` как рабочие таблицы и проверить, какие header/summary блоки всё ещё дублируют друг друга.
...
- Working set (files/ids/commands):
  ...
  - `Z:\\CPP\\ForgeMirror\\data\\meta\\patch-notes\\0.4.69.md`
