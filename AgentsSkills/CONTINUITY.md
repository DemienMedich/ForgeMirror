...
- State: Stage 49 implementation is on codex/qt-gui. Qt now has an OBJ/FBX wireframe viewer, administrator-only 3D settings, persistent fullscreen and frameless window controls; stable branches remain unchanged.
