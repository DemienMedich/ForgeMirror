...
- State:
  - Ветка: develop. Версия: 0.4.96.
  - Последнее изменение: начат общий UX pass, пункт 7 `плотность таблиц и читаемость строк`: clipped text tooltip для длинных значений в таблицах.
