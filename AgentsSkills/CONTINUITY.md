...
- State:
  - Ветка: develop. Версия: 0.4.92.
  - Последнее изменение: продолжен общий UX pass, пункт 6 `визуальная иерархия и статусы`: status pills в project bridge и tint combo в админ-таблице задач.
