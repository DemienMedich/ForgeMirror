...
- State:
  - Ветка: profile. Версия: 0.3.53.
  - Последнее изменение: начисление монет за помодоро + настройки в Хранилище.
- Done:
...
- Now:
  - Проверка начисления монет за помодоро и правил расписания.
- Next:
