...
- State:
  - Ветка: develop. Версия: 0.5.49.
  - Последнее изменение: Stability plan point 1 `ядро задач и XP`: recovery задач, проектов и пайплайна сохраняет повреждённый JSON и сообщает пользователю о восстановлении.
