...
- State:
  - Ветка: develop. Версия: 0.5.15.
  - Последнее изменение: UX plan point 8 `единые empty/active/focus states` продолжен: дополнительные empty-state рабочих блоков задач переведены на общий compact helper.
