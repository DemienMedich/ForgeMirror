...
- State:
  - Ветка: develop. Версия: 0.5.41.
  - Последнее изменение: UX plan point 11 `семантика иконок`: выполнен второй проход по навигации, служебным панелям и empty-state actions.
