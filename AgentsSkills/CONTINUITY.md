...
- State:
  - Ветка: develop. Версия: 0.5.07.
  - Последнее изменение: UX plan point 8 `единые empty/active/focus states` продолжен: сервисные панели логов, хранилища, баннера и админ-статистики переведены на общий compact empty-state helper.
