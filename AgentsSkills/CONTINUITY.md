...
- State:
  - Ветка: develop. Версия: 0.5.32.
  - Последнее изменение: UX plan point 10 `визуальный ритм таблиц и карточек`: action-таблицы профильных модалок и модалок навыков переведены на общий compact table scope.
