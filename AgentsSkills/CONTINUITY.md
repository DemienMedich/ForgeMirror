...
- State:
  - Ветка: codex/tasks-module-ux. Версия: 0.4.40.
  - Последнее изменение: в задачах добавлен быстрый фильтр `Требуют действий` и строковый сигнал `Действие` с причиной в tooltip.
...
- Next:
  - Следующим прогоном логично уплотнить сам модуль задач: развести режимы `оперативная работа` и `администрирование`, чтобы вторичные блоки меньше конкурировали со списком и detail-pane.
