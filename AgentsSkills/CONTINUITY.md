...
- State:
  - Ветка: develop. Версия: 0.5.13.
  - Последнее изменение: UX plan point 8 `единые empty/active/focus states` продолжен: ярлыки, правила и XP-модалка переведены на общий compact empty-state helper.
