...
- State:
  - Ветка: codex/tasks-module-ux. Версия: 0.4.39.
  - Последнее изменение: detail-pane задачи получил блок `Следующее действие`, который подсказывает безопасный следующий шаг и даёт прямой CTA для админа.
