...
- State:
  - Ветка: codex/tasks-module-ux. Версия: 0.4.46.
  - Последнее изменение: добавлено редактирование текста задачи и self-service снятие Злого духа за 200 Кукоинов с переводом монет в хранилище.
