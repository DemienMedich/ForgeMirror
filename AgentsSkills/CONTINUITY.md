...
- State:
  - Ветка: develop. Версия: 0.5.16.
  - Последнее изменение: UX plan point 8 `единые empty/active/focus states` продолжен: профильные модалки без выбранного профиля переведены на общий compact helper.
