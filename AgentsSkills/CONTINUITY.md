...
- State:
  - Ветка: develop. Версия: 0.5.33.
  - Последнее изменение: UX plan point 10 `визуальный ритм таблиц и карточек`: XP-модалка переведена на общий compact table scope для header, участников, фильтров и таблицы навыков.
