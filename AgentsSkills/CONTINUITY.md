...
- Done:
  ...
  - Добавлены patch‑notes до 0.3.17, сборка GUI проходит.
- Now:
...
- Open questions (UNCONFIRMED if needed):
  - UNCONFIRMED: у пользователя всё ещё не отображаются проценты при выставлении оценок (нужна повторная проверка после 0.3.17).
