...
## Текущее состояние
- Ветка: Beta. Текущая версия 0.3.14 (откат UI/UX изменений за последние два дня; восстановлены AgentsSkills UI-гайды; сохранены текущие модули); добавление опыта переведено на оценки 0-5 (автодолей).
