...
- State:
  - Ветка: develop. Версия: 0.5.17.
  - Последнее изменение: UX plan point 8 `единые empty/active/focus states` продолжен: пустой фильтр профилей, пустой каталог навыков и skill merge modal переведены на общий compact helper.
