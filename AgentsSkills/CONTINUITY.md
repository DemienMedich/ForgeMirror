...
- Now:
  - Вкладка профиля `Обзор` оставила подробную таблицу как `Диагностика состояния`, чтобы overview не перегружался, но диагностика оставалась доступной.
- Next:
  - Продолжить компоновку профиля: пройтись по `Топ навыков` и `Категории` в overview, сделать их компактнее или перенести детальные варианты в `Аналитику`.
...
- Working set (files/ids/commands):
  ...
  - `Z:\\CPP\\ForgeMirror\\data\\meta\\patch-notes\\0.4.64.md`
