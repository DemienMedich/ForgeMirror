...
- State:
  - Ветка: develop. Версия: 0.5.25.
  - Последнее изменение: UX plan point 10 `визуальный ритм таблиц и карточек`: исправлена область жизни `CompactTableScopeGui` в основном списке задач, чтобы `PopStyleVar` не происходил после `EndChild`.
