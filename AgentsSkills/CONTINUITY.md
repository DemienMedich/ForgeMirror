...
- State:
  - Ветка: codex/tasks-module-ux. Версия: 0.4.38.
  - Последнее изменение: форма постановки задачи переведена в 4 шага `Основное / Исполнители / Навыки / Проверка`, чтобы админ не работал с длинным полотном полей.
