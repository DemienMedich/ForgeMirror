...
- Ветка: Beta. Текущая версия 0.3.03 (профессии полностью вынесены в отдельный модуль, профиль очищен; навыки сохраняют привязку к профессии при редактировании/весе; health-check/whitelist/patch-notes актуальны).
