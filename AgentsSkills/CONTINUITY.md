...
- State: Stage 53 implementation is on codex/qt-gui. Qt task browsing now filters by project and pipeline stage using stable IDs; stable branches remain unchanged.
...
- Now: Stages 47–52 compiled and were pushed. Stage 53 adds project and pipeline task filters, including explicit unassigned choices and legacy name fallback; compile verification is pending. This is not a release checkpoint: no tests or installer lifecycle checks were run. Stage 46 remains the latest verified installer, version 0.6.11; release evidence: docs/releases/ForgeMirror-0.6.11.md.
