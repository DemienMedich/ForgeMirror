...
- State:
  - Ветка: develop. Версия: 0.5.06.
  - Последнее изменение: UX plan point 8 `единые empty/active/focus states` продолжен: профильные task-блоки переведены на общий compact empty-state helper.
