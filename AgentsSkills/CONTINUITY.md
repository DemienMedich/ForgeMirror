...
- State:
  - Ветка: develop. Версия: 0.4.94.
  - Последнее изменение: продолжен общий UX pass, пункт 6 `визуальная иерархия и статусы`: профильные task-блоки переведены на status pills.
