...
- State:
  - Ветка: develop. Версия: 0.4.97.
  - Последнее изменение: общий UX pass, пункт 7 `плотность таблиц и читаемость строк`: приглушённая task-палитра для warning/info/error и более мягкие status pills.
