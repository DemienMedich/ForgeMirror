...
- State:
  - Ветка: develop. Версия: 0.4.90.
  - Последнее изменение: продолжен общий UX pass, пункт 5 `empty-state и active-state`: action-oriented пустые состояния и явный tint выбранных строк.
