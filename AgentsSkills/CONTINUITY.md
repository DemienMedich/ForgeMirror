...
- State:
  - Ветка: develop. Версия: 0.5.36.
  - Последнее изменение: UX plan point 10 `визуальный ритм таблиц и карточек`: верхнеуровневые сводки и карточки профиля переведены на общий compact table scope.
