...
- State:
  - Ветка: develop. Версия: 0.5.52.
  - Последнее изменение: Product adoption plan point 1 `доказательство пользы`: добавлен core-сервис `AppTeamValueReportService`, а админский CSV-экспорт статистики дописывает блок TeamValueReport по задачам, проектам, просрочке, pending XP, pipeline gaps и исполнителям.
  ...
  - Текущий план-пункт: Product adoption 1 `доказательство пользы`: управленческие метрики и отчётность по фактической работе команды.
- Done:
