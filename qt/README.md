...
| Area | Qt coverage through stage 83 | Remaining |
| --- | --- | --- |
...
Stage 45 push is manual and limited to tasks/pipeline. Automatic pull/push, timers, background conflict decisions and snapshot pruning remain disabled.
