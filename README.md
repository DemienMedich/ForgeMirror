...
## Сборка
Экспериментальный перенос на **Qt Widgets** ведётся в ветке `codex/qt-gui`.
Стабильный снимок до переноса: `codex/pre-qt-2026-08-28` (`7306152`).
Сборка Qt: `./build-qt.ps1 -Package`. Это первый этап, не полная замена ImGui;
поддержанные функции, ограничения и отдельное хранилище описаны в [qt/README.md](qt/README.md).
