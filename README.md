...
- Кулдауны категорий и деградация сейчас отключены; Senior открывается только после 10/10 во всех категориях.
...
- Кулдауны и деградация: отключены (kDecayEnabled=false).
